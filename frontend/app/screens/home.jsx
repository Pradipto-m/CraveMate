      ...
      <ScrollView>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} >
          <View className = "flex flex-row justify-center items-center" >
            <View className = "flex flex-col justify-center items-center m-3 p-2 bg-red-500 rounded-xl w-32 h-44" >
        ...
        <View className="flex-row flex-wrap justify-center items-center mt-4">
          ...
          <View className = "flex flex-col justify-center items-center mb-7 bg-red-500 rounded-2xl h-44" style={{width : width * 0.82}} >
          ...
          <View className = "flex flex-col justify-center items-center mx-6 mb-7 bg-red-500 rounded-xl h-44" style={{width : width * 0.35}} >
          ...
          <View className = "flex flex-col justify-center items-center mx-7 mb-7 bg-red-500 rounded-xl h-44" style={{width : width * 0.35}} >
          ...
          <View className = "flex flex-col justify-center items-center mb-7 bg-red-500 rounded-2xl h-44" style={{width : width * 0.82}} >
            <Image source={{uri : 'https://img.freepik.com/free-photo/fresh-pasta-with-hearty-bolognese-parmesan-cheese-generated-by-ai_188544-9469.jpg'}} className="h-36 rounded-xl" style={{width:width*0.79, resizeMode:'cover'}} />
            <Text className = "font-bold text-red-50" >Special Snacks</Text>
          </View>
          <View className = "flex flex-col justify-center items-center mx-7 mb-7 bg-red-500 rounded-xl h-44" style={{width : width * 0.35}} >
            <Image source={{uri : 'https://www.expatica.com/app/uploads/sites/5/2014/05/french-food.jpg'}} className="w-28 h-36 rounded-lg" style={{width:width*0.32, resizeMode:'cover'}} />
